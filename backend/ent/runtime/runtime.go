...
func init() {
	...
	usagelogDescRefundedCost := usagelogFields[27].Descriptor()
	...
	usagelogDescRefundedTotalCost := usagelogFields[28].Descriptor()
	...
	usagelogDescRefundedAccountCost := usagelogFields[29].Descriptor()
